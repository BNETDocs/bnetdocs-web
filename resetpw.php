<?
	...
	# Reset password disabled due to admin account somehow being hijacked
	$ret = "Reset password has been disabled due to system being under extended maintenance.";
	error($ret);
        return;
