...
require_once('mytinytodo/init.php');
require_once('mytinytodo/lang/class.default.php');
require_once('mytinytodo/lang/'.$config['lang'].'.php');
...
<link rel="stylesheet" type="text/css" href="style.css?v=1.2.7" media="all">
<?php if(isset($_GET['pda'])): ?>
<meta name="viewport" id="viewport" content="width=device-width">
<link rel="stylesheet" type="text/css" href="pda.css?v=1.2.7" media="all">
<?php else: ?>
<link rel="stylesheet" type="text/css" href="print.css?v=1.2.7" media="print">
<?php endif; ?>
</HEAD>
...
<div id="footer"><div id="footer_content">Powered by <strong><a href="http://www.pozdeev.com/mytinytodo/">myTinyTodo</a></strong> v1.2.7 </div></div>
