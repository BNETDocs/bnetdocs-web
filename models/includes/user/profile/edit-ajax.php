<?php
  ...
  echo "          <p>Here you can edit your user profile details.</p>\n";
  echo "          <input type=\"hidden\" name=\"csrf\" value=\"" . htmlspecialchars(AntiCSRF::fGetToken(), ENT_XML1, "UTF-8") . "\" />\n";
  echo "          <label for=\"display_name\" title=\"Enter an alternate name than your username you wish to use.\">Username:</label>\n";
